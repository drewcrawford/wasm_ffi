(module $wasm_export_types_reftest.wasm
  ...
  (func $__wbindgen_free (;2;) (type 3) (param i32 i32 i32))
  (func $__wbindgen_malloc (;3;) (type 2) (param i32 i32) (result i32))
  (func $__wbindgen_realloc (;4;) (type 4) (param i32 i32 i32 i32) (result i32))
  (func $"example externref shim multivalue shim" (;5;) (type 5) (param i32 i64 externref i32 i32) (result i32 i32))
  (func $"example_128 multivalue shim" (;6;) (type 6) (param i64 i64) (result i32 i64 i64))
